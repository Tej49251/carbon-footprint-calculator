...
background = get_base64("./media/bg.jpg")
...
tab_result.markdown(f"""You owe nature <b>{round(prediction / 12, 2)}</b> ton{'s' if prediction > 1 else ''} of CO2 monthly. """, unsafe_allow_html=True)
